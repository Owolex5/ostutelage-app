          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Admissions Are Now Open – Enroll Today!
              </h2>
              <p>
                Don’t miss the chance to join Ostutelage’s interactive virtual
                classes. Learn online with expert instructors, collaborate with
                peers, and gain in-demand skills for your future. Secure your
                spot now!
              </p>
            </motion.div>

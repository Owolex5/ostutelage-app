      ...
      <section>
        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `INTEGRATIONS`,
              subtitle: `Seamless Learning on Any Platform`,
              description: `Ostutelage connects with the tools you already use — from collaboration platforms to video conferencing. Learn, share, and grow without limits, no matter where you are.`,
            }}
          />
          {/* <!-- Section Title End --> */}
        </div>
